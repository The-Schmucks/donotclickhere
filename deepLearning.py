...
class Ai:
    ...
    def memory(self):
        ...
        # for special characters we used number divided by one hundred
        memory = {'1': float(1), '2': float(2), '3': float(3), '4': float(4), '5': float(5), '6': float(6),
                  '7': float(7), '8': float(8), '9': float(9), '0': float(0),
                  ...
                  'l': float(1.2), 'm': float(1.3), 'n': float(1.4), 'o': float(1.5), 'p': float(1.6), 'q': float(1.7),
                  'r': float(1.8), 's': float(1.9), 't': float(2.8),
    ...
    def logic(self):
        ...
        inputs_value = self.inputsValue()
        print('inputs value: ', inputs_value)
